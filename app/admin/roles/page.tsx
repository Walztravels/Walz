...
const PERM_META: Record<Permission, PermMeta> = {
  ...
  'finance.revenue':      { label: 'Revenue Intelligence',           desc: 'View GBV, payment provider breakdown, funnel, and margin data — Finance section only' },
...
const PERM_GROUPS: { label: string; perms: Permission[] }[] = [
  ...
  { label: 'Finance',              perms: ['payments', 'payments.refund', 'payments.all', 'reports', 'reports.financial', 'reports.all', 'commissions', 'payroll', 'finance.revenue'] },
