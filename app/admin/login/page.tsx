...
import { Globe, Eye, EyeOff, Lock } from 'lucide-react'
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#C9A84C] mb-4">
            <Globe className="w-8 h-8 text-[#0B1F3A]" />
          </div>
          <h1 className="text-2xl font-bold text-white">Walz Travels</h1>
          <p className="text-white/50 text-sm mt-1 tracking-wider uppercase">Admin Portal</p>
        </div>
