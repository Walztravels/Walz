...
const GROUPS = [
  {
    ...
    keys: [
      ...
      { key: 'business_address', type: 'text',  hint: 'Shown in footer copyright line' },
      { key: 'business_email',   type: 'email', hint: 'Primary contact email' },
      { key: 'office_address',   type: 'text',  hint: 'Full street address (legacy)' },
