...
function PayLaterForm({ appId, refNumber }: { appId: string; refNumber: string }) {
  ...
  if (sent) {
    return (
      <div className="text-center py-8">
        ...
        <a href="https://wa.me/447949448680" target="_blank" rel="noopener noreferrer"
  ...
  return (
    <div className="space-y-4">
      ...
      <a href={`https://wa.me/447949448680?text=Hi+Jade,+I'd+like+to+pay+for+my+visa+application+by+bank+transfer.+Reference:+${refNumber}`}
