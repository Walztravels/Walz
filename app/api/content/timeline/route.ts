...
const FALLBACK = [
  ...
  { id: '4', icon: 'globe',    title: 'Global Platform',     description: 'THE WALZ TRAVELS INC incorporated in Ontario, Canada. Full global travel platform launched at walztravels.com — serving clients across five markets worldwide with one unified experience.', order: 3 },
]
