...
const DEFAULT_TIMELINE = [
  ...
  { icon: 'globe',    title: 'Global Platform',      order: 3, active: true, description: 'THE WALZ TRAVELS INC incorporated in Ontario, Canada. Full global travel platform launched at walztravels.us — serving clients across six markets worldwide with one unified experience.' },
]
