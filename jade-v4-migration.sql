-- Jade v4 migration — run once in Supabase SQL editor
-- Creates: family_constellations, whisper_queue, visa_assessments
...
CREATE INDEX IF NOT EXISTS idx_whisper_active ON whisper_queue(last_activity) WHERE is_active = true;
