...
const footerLinks = {
  ...
  support: [
    ...
    { label: 'SMS Updates', href: '/sms-consent' },
...
const socialLinks = [
  { label: 'Instagram', href: 'https://instagram.com/walz_travels',           Icon: InstagramIcon },
  ...
  { label: 'TikTok',    href: 'https://tiktok.com/@walztravels',              Icon: TikTokIcon    },
