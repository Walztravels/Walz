...
const ROUTES = [
  { from: 'LHR', fromCity: 'London',  to: 'LOS', toCity: 'Lagos',    price: 680,  currency: 'GBP', label: 'Hot Deal', dates: '14 Jul – 24 Jul',  image: '🇳🇬', span2: true  },
  { from: 'YYZ', fromCity: 'Toronto', to: 'LOS', toCity: 'Lagos',    price: 750,  currency: 'CAD', label: 'Popular',  dates: '20 Dec – 10 Jan',  image: '🇳🇬', span2: false },
  { from: 'LHR', fromCity: 'London',  to: 'ACC', toCity: 'Accra',    price: 620,  currency: 'GBP', label: 'Direct',   dates: 'Flexible dates',   image: '🇬🇭', span2: false },
  { from: 'LHR', fromCity: 'London',  to: 'DXB', toCity: 'Dubai',    price: 280,  currency: 'GBP', label: 'Hot Deal', dates: 'From Nov 2024',    image: '🇦🇪', span2: false },
  { from: 'LHR', fromCity: 'London',  to: 'JFK', toCity: 'New York', price: 380,  currency: 'GBP', label: 'Popular',  dates: 'Flexible dates',   image: '🇺🇸', span2: false },
  { from: 'YYZ', fromCity: 'Toronto', to: 'ACC', toCity: 'Accra',    price: 890,  currency: 'CAD', label: 'New',      dates: 'Dec 2024',         image: '🇬🇭', span2: false },
]
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {ROUTES.map((route, i) => (
            <a key={`${route.from}-${route.to}-${i}`}
              href={`/flights/search?from=${route.from}&to=${route.to}&trip=round-trip&cabin=ECONOMY&adults=1&children=0`}
              ...
              <div className="p-5 flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-[#0B1F3A]/40">{route.dates} · Round trip</p>
                </div>
