...
interface PaymentFormProps {
  ...
  onSuccess: (transactionId: string, gateway: 'flutterwave' | 'stripe') => void
...
export function PaymentForm({
  ...
  const [gateway, setGateway] = useState<'flutterwave' | 'stripe'>('flutterwave')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-2 p-1 bg-walz-off-white rounded-xl border border-walz-border">
        <button
          type="button"
