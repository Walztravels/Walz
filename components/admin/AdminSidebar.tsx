...
import {
  ...
  Settings, LayoutGrid, Image, LogOut, ChevronRight, Globe,
} from 'lucide-react'
    ...
    <aside className="flex flex-col w-64 min-h-screen bg-[#0B1F3A] text-white">
      ...
      <div className="px-6 py-6 border-b border-white/10">
        <Link href="/admin/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-white text-sm leading-tight">Walz Travels</div>
            <div className="text-[10px] text-[#C9A84C] tracking-widest uppercase">Admin CRM</div>
          </div>
        </Link>
      </div>
