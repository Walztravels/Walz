...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: 'inbox_view_all',          label: 'See All Inbox',        desc: 'View all conversations, not just assigned or unassigned ones' },
  ...
  },
  {
    label: 'Concierge',
    keys: [
      { key: 'concierge_view',         label: 'View Concierge',          desc: 'See concierge requests and service history' },
      { key: 'concierge_book',         label: 'Book Concierge Services',  desc: 'Place bookings for private aviation and airport services on behalf of clients' },
      { key: 'concierge_manage_images', label: 'Manage Page Images',      desc: 'Upload and update hero images on the public concierge page' },
    ],
  },
  {
...
export const ROLE_DEFAULTS: Record<string, Partial<Record<PermissionKey, boolean>>> = {
  ...
  operations_manager: {
    ...
    inbox_view: T, inbox_view_all: T, inbox_reply: T, inbox_assign: T, inbox_delete: F,
  ...
  visa_officer: {
    ...
    inbox_view: T, inbox_view_all: F, inbox_reply: T, inbox_assign: F, inbox_delete: F,
  ...
  accountant: {
    ...
    inbox_view: T, inbox_view_all: F, inbox_reply: F, inbox_assign: F, inbox_delete: F,
    notifications_view: T, notifications_send: F, notifications_broadcast: F,
    destinations_view: F, destinations_edit: F, hotel_promos_view: F, hotel_promos_edit: F, flight_extras_view: F, jade_miles_view: F,
    cms_view: F, cms_edit: F, cms_publish: F,
    roles_view: F, roles_manage: F, roles_assign: F,
