...
function emailHeader(): string {
  return `
    <div style="background: linear-gradient(135deg, #0A1628, #1C3557); padding: 40px 40px 32px; text-align: center;">
      <div style="margin-bottom: 8px;">
        <span style="font-size: 28px; font-weight: 700; color: #C9A84C; letter-spacing: 2px;">W</span>
        <span style="font-size: 22px; font-weight: 600; color: #FFFFFF; margin-left: 8px;">Walz Travels</span>
      </div>
            ...
            <div style="padding: 16px 20px;">
              ${
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                  ...
                  <span style="color: #1C3557; font-size: 13px;">${formatCurrency(booking.totalPrice - booking.serviceFee - selectedAddons.reduce((s, a) => s + a.price, 0), booking.currency)}</span>
                </div>
                ${
                  selectedAddons.length > 0
                    ? `
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
                  <span style="color: #8B9BAE; font-size: 13px;">Service Fee</span>
                  <span style="color: #1C3557; font-size: 13px;">${formatCurrency(booking.serviceFee, booking.currency)}</span>
                </div>
    ...
    <body style="margin: 0; padding: 16px; font-family: system-ui, sans-serif; background: #f5f5f5;">
      <div style="max-width: 900px; margin: 0 auto; background: #fff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <div style="background: #0A1628; padding: 24px 32px; display: flex; align-items: center; justify-content: space-between;">
          <div>
            <span style="color: #C9A84C; font-size: 20px; font-weight: 700;">Walz Travels</span>
            <span style="color: #8B9BAE; font-size: 13px; margin-left: 12px;">Admin Notification</span>
          </div>
        ...
        <div style="padding: 32px;">
          ...
          <div style="margin-bottom: 24px; padding: 16px; background: #F7F4EF; border-radius: 8px; border-left: 4px solid #22c55e;">
            ...
            ${data.serviceFee ? `<p style="margin: 4px 0; color: #1C3557;"><strong>Service Fee:</strong> ${formatCurrency(data.serviceFee, data.currency)}</p>` : ''}
          </div>
