...
export const NAV_ITEMS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/team',        label: 'Team Hub',            icon: 'Users2',          permission: 'dashboard'       },
    ],
  },
  {
    section: 'QUOTES',
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/cabin-profiles',   label: 'Cabin Profiles',   icon: 'Image',   permission: 'flights' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/recruitment/compliance',  label: 'Compliance',      icon: 'ShieldCheck', permission: 'content' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/settings/signature',        label: 'Email Signature', icon: 'Mail',        permission: 'settings'     },
    ],
  },
]
